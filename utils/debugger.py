# Some convenience functions for configuring and debugging the people counting process
...
def mouse_callback(event, x, y, flags, param):
    """
    A handler for mouse events in the debug window
    """
...
def capture_pixel_position(window_x, window_y, frame_w, frame_h):
    """
    To capture the position of a pixel in a video frame
    """
...
def take_screenshot(frame):
    """
    To save a frame to file as a screenshot
    """
